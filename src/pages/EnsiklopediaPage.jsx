...
const tanamanFoto = {
  kunyit: "/kunyit.png",
  temulawak: "/temulawak.jpg",
  jahe: "/jahe.jpeg",
  kencur: "/kencur.jpg",
  "daun-sirih": "/daun-sirih.jpg",
  "asam-jawa": "/asam-jawa.jpg",
  "daun-kelor": "/daun-kelor.jpg",
  lengkuas: "/lengkuas.jpg",
  sambiloto: "/sambiroto.jpeg",
};
...
export default function EnsiklopediaPage() {
  ...
  const tanamanList = Object.entries(tanamanFoto).map(([slug, foto]) => ({
    slug,
    foto,
    nama: t(`tanamanData.${slug}.nama`),
    desc: t(`tanamanData.${slug}.desc`),
    tag: t(`tanamanData.${slug}.tag`),
  }));
        ...
        {tab === "tanaman" && (
          <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            {filteredTanaman.length === 0 && (
              <p className="col-span-full text-center text-stone-400 text-sm py-10">{t("ensiklopedia.tanamanKosong")}</p>
            )}
          </div>
        )}
        ...
        {tab === "racikan" && (
          <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            {filteredRacikan.length === 0 && (
              <p className="col-span-full text-center text-stone-400 text-sm py-10">{t("ensiklopedia.racikanKosong")}</p>
            )}
          </div>
        )}
      </div>
