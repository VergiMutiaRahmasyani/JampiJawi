import {
  ArrowRight, PlayCircle, ShieldAlert, BookOpenCheck, Leaf, BadgeCheck, Brain, Search, Sparkles,} from "lucide-react";
import ArtikelHorizontalSection from "../components/shared/ArtikelHorizontalSection";
...
export default function HomePage() {
  return (
    <div className="bg-white text-stone-800">
      ...
      {/* ============ ARTIKEL PREVIEW — horizontal scroll ============ */}
      <ArtikelHorizontalSection artikel={artikel} />
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-wrap justify-between items-end gap-4">
              <div>
