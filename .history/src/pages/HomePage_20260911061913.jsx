...
const tanaman = [
  { nama: "Kunyit", latin: "Curcuma longa", senyawa: "Kurkumin", desc: "Rimpang kuning yang jadi bahan utama jamu kunyit asam, dikenal turun-temurun untuk meredakan pegal dan menjaga daya tahan tubuh." },
  { nama: "Temulawak", latin: "Curcuma xanthorrhiza", senyawa: "Kurkuminoid", desc: "Rimpang khas Jawa yang dipercaya membantu menjaga fungsi hati dan melancarkan pencernaan." },
  { nama: "Kencur", latin: "Kaempferia galanga", senyawa: "Etil Sinamat", desc: "Bahan utama jamu beras kencur, dikenal untuk melegakan tenggorokan dan memulihkan stamina." },
  { nama: "Daun Kelor", latin: "Moringa oleifera", senyawa: "Flavonoid", desc: "Daun kaya zat besi dan mineral yang umum dipakai untuk menjaga imunitas keluarga sehari-hari." },
];
    ...
    <div className="bg-white text-stone-800">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <span className="text-xs font-semibold text-emerald-700 tracking-wide">PUSTAKA JAMU JAWA</span>
          <h2 className="mt-3 text-3xl font-bold text-stone-900">
            Ensiklopedia Tanaman & Jamu Jawa
          </h2>
          <p className="mt-3 text-stone-500 max-w-xl mx-auto text-sm">
            Cari dan pelajari khasiat tanaman herbal khas Jawa beserta
            kandungannya dan cara meraciknya menjadi jamu.
          </p>
          ...
          <div className="mt-8 max-w-xl mx-auto flex items-center gap-2 bg-white border border-stone-200 rounded-full px-4 py-2">
            ...
            <input
              type="text"
              placeholder="Ketik nama tanaman atau keluhan (cth: Temulawak, pegal linu)..."
