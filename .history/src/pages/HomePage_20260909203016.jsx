    ...
    <div className="bg-white text-stone-800">
      ...
      <section className="py-20">
        ...
        <div className="max-w-7xl mx-auto px-6 mt-12">
          <div className="bg-stone-900 rounded-3xl px-8 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <span className="text-xs font-semibold text-emerald-400 tracking-wide">
                KESEHATAN PREVENTIF BERKELANJUTAN
              </span>
              <h3 className="mt-2 text-2xl font-bold text-white">
                Dirancang untuk Pemulihan Berkelanjutan
              </h3>
              <p className="mt-2 text-stone-400 max-w-lg text-sm">
                Bukan sekadar katalog tanaman acak. Jampi Jawi bertindak
                sebagai pendamping kesehatan harian keluarga Indonesia untuk
                menjaga imunitas tanpa ketergantungan berlebih.
              </p>
            </div>
            <button className="shrink-0 inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white font-medium px-5 py-3 rounded-xl transition">
              Skrining Sekarang <ArrowRight size={18} />
            </button>
          </div>
        </div>
      </section>
